...
const vehicleStatssReducer = function (state = initialState, action) {
    switch (action.type) {
        case Actions.SET_VEHICLE_STATSS:
            {
        ...
        case Actions.SET_VEHICLE_STATSS_PAGE:
            {
                return {
                    ...state,
                    page: action.page
        ...
        case Actions.SET_VEHICLE_STATSS_ROWS_PER_PAGE:
            {
                return {
                    ...state,
        ...
        case Actions.SET_VEHICLE_STATSS_ORDER:
            {
                return {
                    ...state,
                    order: action.order
        ...
        case Actions.SET_VEHICLE_STATSS_FILTERS_ORGANIZATION_ID:
            {
                return {
                    ...state,
        ...
        case Actions.SET_VEHICLE_STATSS_FILTERS_NAME:
            {
                return {
                    ...state,
        ...
        case Actions.SET_VEHICLE_STATSS_FILTERS_ACTIVE:
            {
                return {
                    ...state,
