    ...
    return (
        <div>
            <TextField
                ...
                label={T.translate("vehicle_stats.metadata.createdBy")}
                id="createdBy"
                name="createdBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("vehicle_stats.metadata.createdAt")}
                id="createdAt"
                name="createdAt"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("vehicle_stats.metadata.updatedBy")}
                id="updatedBy"
                name="updatedBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("vehicle_stats.metadata.updatedAt")}
                id="updatedAt"
                name="updatedAt"
